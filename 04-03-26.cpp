...
int main(){
	...
	printf("La variable char tiene una valor de %c\n varint=%d\n varfloat=%f\n cadena=%s",c,i,f,letras);
	system("pause");
	printf("Impresion sin esapacios \n");
	printf("%d%f%c%s\n,i,f,c,letras");
	...
	fflush(stdin);
	scanf("%[^\n]",letras);
	printf("entero: %d, flotante: %f, caractr: %c, cadena: %s\n",i,f,c,letras);
	i=12345;
	f=345.678;
	...
	printf("%d %d %d\n",1,10,20);
	system("pause");
	printf("Probando anchosen floats: 3, 10 y 13 espacios\n");
	printf("%3f %10f %13f\n",f,f,f);
	system("pause");
	...
	system("pause");
	f=123.456;
	printf("Probando diferentes cantidaddes de cifras 7.0, 7.3 y 7.1\n");
